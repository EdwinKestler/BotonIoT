...
const char responseTopic[] ="iotdm-1/response/1045012";
...
IPAddress timeServer(192,168,120,211); // time.nist.gov NTP server
const char* ntpServerName = "192.168.120.211";
